...
var rangoNumerosIzq = _lodash.default.range(1, 90);

var rangoNumerosDer = _lodash.default.range(1, 90);

var rangoNumerosGenerados = _lodash.default.range(0, 90);

boton.onclick = generarNumerosCentro;
crearNumeros(rangoNumerosIzq, parentIzq);
crearNumeros(rangoNumerosDer, parentDer);

function crearNumeros(carton, parent) {
  for (var index = 0; index < 15; index++) {
    //sampleSize devuelve un valor aleatorio del array
    var numeroRandom = _lodash.default.sampleSize(carton);

    _lodash.default.pull(carton, parseInt(numeroRandom));

    var div = document.createElement("div");
    div.className = "numeroSinTachar";
    div.textContent = numeroRandom;
...
function generarNumerosCentro() {
  ...
  console.log(rangoNumerosGenerados);
  var div = document.querySelector(".numeroAleatorio");
  div.textContent = numeroRandom;
  aciertosUser = comprobarNumeros(parentIzq, aciertosUser);
  aciertosCPU = comprobarNumeros(parentDer, aciertosCPU);
...
function comprobarNumeros(parent, aciertos) {
  for (var index = 0; index < parent.childElementCount; index++) {
    var child = parent.children[index];

    if (child.innerHTML == numeroCentro.innerHTML) {
      child.classList.add("numeroTachado");
      aciertos += 1;
    }
  }
...
//# sourceMappingURL=/bingoJS/js.00a46daa.js.map